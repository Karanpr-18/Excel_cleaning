...
class KadamValidator:
    """Original Kadam Excel file validator - optimized version"""
    ...
    def validate_cell(self, value, rules, col_name, data_df, row_idx):
        ...
        # Special age validation for Student's Age
    ...
    def validate_excel(self, file_path, unique_id, download_folder='downloads'):
        ...
        try:
            ...
            # Process each column with vectorized operations where possible
            for col_name, rules in self.validation_rules.items():
                ...
                # Vectorized validation for each cell
            ...
            output_path = os.path.join(download_folder, f"{unique_id}_Validated_Output.xlsx")
            report_path = os.path.join(download_folder, f"{unique_id}_Validation_Report.xlsx")
